...
public class ReadAuthorByIdCommand extends AbstractCommand<AuthorDtoReq, AuthorDtoRes, Long> implements Command {


    public ReadAuthorByIdCommand(BaseController<AuthorDtoReq, AuthorDtoRes, Long> controller, Scanner scanner) {
