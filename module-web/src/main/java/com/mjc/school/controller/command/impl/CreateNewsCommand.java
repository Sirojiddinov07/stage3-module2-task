...
public class CreateNewsCommand extends AbstractCommand<NewsDtoReq, NewsDtoRes, Long> implements Command  {

    public CreateNewsCommand(BaseController<NewsDtoReq, NewsDtoRes, Long> controller, Scanner scanner) {
